...
He decidido crear un sitio web para que las personas puedan ofrecer espacios de que dispongan o acceder a los espacios de otras personas para poder realizar un trabajo cooperativo, basado en la iniciativa de una empresa de Coworking, Cubikate. El enlace a la página web de Cubikate es el siguiente: https://cubikate.es/ 
